...
import { Button, TextInput, Label, Table } from 'flowbite-react';
        ...
        <div className="container mx-auto mt-5">
            ...
            <form onSubmit={editMode ? updateItem : addItem} className="mt-4">
                ...
                <TextInput
                    ...
                    required
                />
                <Label className="block mt-4 mb-2" htmlFor="description">Description</Label>
                <TextInput
                    id="description"
                ...
                {editMode && (
                    <Button onClick={resetForm} className="mt-4 ml-2" color="gray">
                        Cancel
                    </Button>
                )}
            </form>
                    ...
                    {items.map((item) => (
                        <Table.Row key={item.id}>
                            ...
                            <Table.Cell>
                                ...
                                <Button onClick={() => deleteItem(item.id)} color="red" className="ml-2">
                                    Delete
                                </Button>
                            </Table.Cell>
                        </Table.Row>
