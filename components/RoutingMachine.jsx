...
export default function RoutingMachine({ currentPos }) {
  ...
  useEffect(() => {
    const routingInstance = L.Routing.control({
      waypoints: [L.latLng(currentPos[0], currentPos[1]), L.latLng(27.5, 85.0)],
      lineOptions: {
        styles: [{ color: "#367bf6", opacity: 1, weight: 5 }],
      },
      addWaypoints: false,
